...
_TRANSITION_TABLE: Final[Mapping[TransitionKey, str]] = MappingProxyType(
    {
        ...
        ("worker_running", "agent-complete", "worker"): "awaiting_visual_verifier",
        ("worker_running", "regression-passed", "worker"): "accepted",
        ("worker_running", "regression-failed", "worker"): "correction_required",
        ("awaiting_visual_verifier", "visual-verifier-dispatched", "visual-verifier"): "visual_verifier_running",
        ("visual_verifier_running", "regression-passed", "visual-verifier"): "accepted",
        ("visual_verifier_running", "regression-failed", "visual-verifier"): "correction_required",
...
_NEXT_ACTIONS: Final[Mapping[str, str]] = MappingProxyType(
    {
        ...
        "awaiting_visual_verifier": "dispatch_visual_verifier",
        "visual_verifier_running": "await_visual_verifier_exit",
        "awaiting_reviewer": "dispatch_reviewer",
        "reviewer_running": "await_reviewer_exit",
        "reviewer_complete": "main_reviewer_decision",
        "repair_plan_required": "repair_plan",
