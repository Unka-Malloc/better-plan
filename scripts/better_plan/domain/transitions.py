...
_TRANSITION_TABLE: Final[Mapping[TransitionKey, str]] = MappingProxyType(
    {
        ...
        ("repair_required", "executor-dispatched", "executor"): "executor_running",
        ("executor_running", "regression-passed", "system"): "awaiting_auditor",
        ("executor_running", "regression-failed", "system"): "repair_required",
        ...
        ("auditor_running", "audit-failed", "implementation"): "repair_required",
...
_NEXT_ACTIONS: Final[Mapping[str, str]] = MappingProxyType(
    {
        ...
        "awaiting_acceptance_review": "dispatch_acceptance_reviewer",
        "acceptance_reviewer_running": "await_acceptance_reviewer_verdict",
        ...
        "repair_required": "main_repair_decision",
